...
Cannabis additions: `src/Items/JointItem.cs`, `src/Systems/StonedSystem.cs`, `src/Client/Stoned{HudSystem,EyesBehavior}.cs`; nine crop shapes plus bud/joint item models; `tools/build_cannabis_models.py`, `tools/preview_cannabis_models.py`, `tools/build_joint_audio.py`; live probe in `tests/CannabisProbe`. Documentation: `docs/CANNABIS.md`.
