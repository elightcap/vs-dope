...
- **Decline**: each sale adds units x exposure (opium 1, morphine/coca 2, heroin 4). Stages at 8/24/48 pick the texture alternate at spawn and add 2% per stage to the per-sale overdose chance. After 3 days without buying, exposure drops 20% per day, unless the addict rolled `Stubborn` (40%) at creation.
